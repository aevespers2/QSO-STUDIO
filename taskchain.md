...
- **Next objective:** Review and approve the QSO-STUDIO product/UX charter, portable-trust review profile, obstruction/gluing analysis, and documentation foundation before building an application.
...
QSO-STUDIO and AionUi overlap as evidence-review surfaces without one accepted contract for review records, annotations, comparison, exports, approval references, corrections, revocations, caches, and recovery state. The lowest-coupling candidate keeps QSO-STUDIO domain-neutral while AionUi remains an optional compatible desktop/WebUI host adapter. This remains unapproved.
...
| P0A | Approve review-surface ownership and AionUi boundary | Architect | QSO-STUDIO and AionUi profiles | BLOCKED | QSO-STUDIO, AionUi, external approval, and Repository `1` responsibilities are accepted without overlapping authority. |
