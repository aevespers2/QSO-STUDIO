...
- Added equivalent prose for both consumer pipeline diagrams.

### Release
- Documentation and consumer candidates remain blocked on charter, platform, license, ownership, upstream contracts, namespace/payload partitioning, reviewer-governance decisions, manual reviews, publication approval, and resulting-route verification.

### Deployment
- No Pages publication, application deployment, package release, ecosystem admission, reviewer appointment, architecture activation, or infrastructure change is authorized by this milestone.
