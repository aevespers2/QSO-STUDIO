...
- [x] Replace the unsupported claim that a Pages site is already published.
- [x] Add a documentation front door and deterministic reader path.
- [x] Add a product and UX charter with explicit users, scope, and non-goals.
...
- [x] Rebind the independent ecosystem-manifest consumer to current `main` and QSO-FABRIC PR #21 head `25036a5cfcea79e204a4660ddd1af09c054935b1`.
- [x] Preserve manifest byte identity through Git blob `5070ac6615b8127b14a9f230678f58a081c6c2c4` and SHA-256 `c5e6d2e42fdbe9703d9f28c7f65ffff02208bff52fa96ee7090bfcbcb5dea728`.
- [x] Add an independently authored strict manifest consumer, source-tuple gate, hostile regressions, exact-head workflow, and retained evidence path.
- [x] Extract the architecture-review consumer from stale PR #4 onto current `main`.
- [x] Rebind its producer tuple to QSO Field PR #24 head `a56b1fa93f151ee14f3cdd4183b89a10e268e352`, workflow `30000668553`, artifact `8560824564`, and digest `sha256:f266006a19bd8a5d95b4c7aeedfc0bac950f1932d7b58eef88ee7eac6f62e77a`.
- [x] Preserve the independent review evaluator, source-before-parse identity gates, synthetic base/extension corpora, hostile regressions, and non-authority semantics.
- [x] Add a current documentation route and a least-privilege exact-head workflow for the architecture-review consumer.
...
- [ ] Decide neutral custody for ecosystem contracts, namespaces, schemas, reason codes, source refresh, supersession, correction, migration, review governance, and rollback.
- [ ] Define real reviewer qualification, appointment, acceptance, conflict, appeal, emergency-review, decision, activation, correction, and supersession ownership before any synthetic review state is used operationally.

## Before a documentation release

- [ ] Exact-head documentation workflow passes.
...
- [ ] Approve one versioned synthetic fixture envelope.
